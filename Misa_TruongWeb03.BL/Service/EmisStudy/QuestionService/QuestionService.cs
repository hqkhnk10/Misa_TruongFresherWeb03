...
namespace Misa_TruongWeb03.BL.Service.EmisStudy.QuestionService
{
    public class QuestionService : BaseService<Question, QuestionDTO, QuestionPostDTO, QuestionPostDTO, QuestionPutDTO>, IQuestionService
    {
        ...
        #endregion
        #region Constructor
        public QuestionService(IExerciseService exerciseService, IQuestionRepository questionRepository, IAnswerRepository answerRepository, IMapper mapper, IUnitOfWork unitOfWork) : base(questionRepository, mapper)
        {
